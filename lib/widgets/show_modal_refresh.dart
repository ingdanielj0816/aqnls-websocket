...
Future<void> showModalRefresh(
    BuildContext context, messageType, String redirectRoute) async {
  await showDialog(
      context: context,
      builder: (_) => Dialog(
            ...
            child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SmallText(
                      text:
                          messageType == 'success' ? 'CORRECTO' : 'INCORRECTO',
                      fontSize: 25,
                      fontWeight: FontWeight.w900,
                      shadowColor: messageType == 'success'
                                          ...
                                          if (snapshot.connectionState ==
                                            ...
                                            return Positioned(
                                              ...
                                              child: BounceInDown(
                                                ...
                                                child: const Image(
                                                  image: AssetImage(
                                                      'assets/images/animated-coins.gif'),
                                                  width: 90,
                                                ),
                                              ),
                                            );
                        ...
                        onTap: () {
                          if (messageType == 'success') {
                            if (redirectRoute.isNotEmpty) {
                              Get.offAndToNamed(redirectRoute);
                            } else {
